...
export function FormModal(props: FormModalProps) {
  const { triggerProps, inputs, submitProps, updateUser, modalState, loadingState, title } = props;
    ...
    >
      ...
      <Modal.Content>
        <Form>
          ...
          <Button loading={loadingState.isLoading} onClick={updateUser} {...submitProps} positive />
